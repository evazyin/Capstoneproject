'''version4 seed words algorithm defining NEAR instead of in one status 05/11'''
'''changed the cooccurancy definition to N word window instead of the same status ----
