...
2 read in a preprocessed dataset
3 do rough search
4 generate two corpus: IR(temporary) and EC(from IR, temporary, should not be)(in another file for EC)
'''

file = open('D:/uw course/capstone/mypersonality/status_a_lemma.txt','r')
file1 = open('D:/uw course/capstone/mypersonality/wordlist_lemma.txt','r')
file2 = open('D:/uw course/capstone/mypersonality/IRtest2.txt','w')
